class FancyTar < Formula
  ...
  url "https://github.com/jgiambona/fancy-tar/releases/download/v1.3.11/fancy-tar-1.3.11.tar.gz"
  sha256 "e39990766cac2362ef028298f85c9381ee644ed397b93db8c5201ab801480ca2"
  license "MIT"
