class FancyTar < Formula
  ...
  url "https://github.com/jgiambona/fancy-tar/releases/download/v1.4.4/fancy-tar-1.4.4.tar.gz"
  sha256 "2591c99389882a4ff28073d6508c57093208f63860e34cd948083d9c871717b0"
  license "MIT"
